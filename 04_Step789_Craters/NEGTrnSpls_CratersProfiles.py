...
def calc_attributes(line_j, center_elev, center, line_ID):
    ...
    # We only keep crater candidate's ID and line's ID.
...
input_path =  parent_path + "/InputData"
output_path = parent_path + "/OutputData"

# Main function.
# Read the crater candidates centers' data.
CentersFileName = (input_path + "/TrainSamples_CratersCenters")
...
#  training area.
NoCratersFileName = input_path+ "/Train_NoCraters.tif"
...
DEMFileName = (input_path + "/TrainDEM_500m_calc.tif")
...
with open (output_path + "/crcs_train_NEG_prfs_RF.csv", "w", newline = '') as csv_data:
